...
<body>
    ...
    <nav>
        <div class="wyszukiwarka">
                ...
                <label>Czego szukasz: <input size="17" maxlength="256" style="margin-right: 10px" type="search"></label>

                <label for="kategoria" style="margin-right: 10px"> Wybierz kategorie: </label>

                <select id="kategoria" style="margin-right: 10px" >

                    <option selected>Wszytskie kategorie</option>
                ...
                <label>Lokalizacja: <input style="margin-right: 10px" placeholder="Miejscowość" type="search"></label>

                <label>Cena od: <input type="search" size="4"></label>
                <label>do: <input type="search" size="4"> </label>
             ...
             <div class="ogloszenie-akc">
                ...
                <section>
                    <div class="gora">
                        ...
                        <section>
                             <div class="tresc"><?php echo $opis_temp; ?> </div>
                        </section>
                    </div>
                </section>
                ...
                <section>
                    <div class="dol">
                        <div class = "kontakt-akc">

                             <div class="row">
                                 <label>Imię : <?php echo $imie_temp; ?></label>
                             </div>

                             <div class="row">
                                 <label>Telefon : <?php echo $telefon_temp; ?></label>
                             </div>
                        ...
                        <section class= "akcept">

													<form <?php echo 'action="akceptacja.php?id_ogl='.$id_ogl.'"' ;?> method="post">

                             <div class="row">
                                 <label>Podana kategoria : <?php echo $kategoria_temp; ?></label>
                             </div>

                             <div class="row">

                                 <label>Zmień kategorie :</label>
                                 <select id="kategoria2" name="a_kategoria">
                                        <option >elektronika</option>
                                        <option >dom i ogród</option>
                                        <option >motoryzacja</option>
                                        <option >praca</option>
                                        <option >moda</option>
																				<option >inne</option>
																				<option selected><?php echo $kategoria_temp; ?></option>
                                 </select>

                             </div>

                            <input type="submit" value="Akceptuj" name="akceptuj">
                            <input type="submit" value="Odrzuć" name="odrzuc">
													</form>
                        </section>
